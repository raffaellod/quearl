...
/** End of the finite-states machine. */
define('QL__HG_END',      0);
...
/** Parses and breaks down an RFC 2616 (“HTTP/1.1”) response string. If the headers are not
complete, it returns false to indicate that it should be called again once more data has been
